<div class="search-bar closed">
      ...
      </div><a href="index.html" class="brand pull-left"><img src="/img/template/logo/logo-light.png" alt="" width="100"></a><a href="javascript:;" role="button" class="hamburger-menu pull-left"><span></span></a>
          ...
          <div aria-labelledby="dropdownMenu1" class="dropdown-menu dropdown-menu-right dm-medium fs-12 animated fadeInDown">
            ...
            <ul data-mcs-theme="minimal-dark" class="media-list mCustomScrollbar">
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="/img/template/users/17.jpg" alt="" class="media-object img-circle"><span class="status bg-warning"></span></div>
              ...
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="/img/template/users/19.jpg" alt="" class="media-object img-circle"><span class="status bg-danger"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="/img/template/users/12.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="/img/template/users/13.jpg" alt="" class="media-object img-circle"><span class="status bg-warning"></span></div>
                  <div class="media-body">
